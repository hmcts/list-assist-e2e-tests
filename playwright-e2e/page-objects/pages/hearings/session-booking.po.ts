...
export class SessionBookingPage extends Base {
  readonly CONSTANTS = {
    ...
    CASE_LISTING_LOCALITY_CARMARTHEN_CC_FC:
      "Carmarthen County Court and Family Court",
    CASE_LISTING_LOCATION_CARMARTHEN_CRTRM_01: "Carmarthen Courtroom 01",
    ...
    // JOH User - HPI API Amendment
    AUTO_JUDICIAL_OFFICE_HOLDER_USER_AUTO_CHRISTOPHER_BENNETT:
      "BENNETT, AUTO_CHRISTOPHER (CHRISTOPHER_BENNETT)",
